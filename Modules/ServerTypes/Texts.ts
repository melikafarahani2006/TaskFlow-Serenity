...
namespace texts {
    export declare namespace Db {
        ...
        namespace TaskFlow {
            export function asKey(): typeof TaskFlow;
            export function asTry(): typeof TaskFlow;
            namespace Project {
                export function asKey(): typeof Project;
                export function asTry(): typeof Project;
            ...
            namespace Tag {
                export function asKey(): typeof Tag;
                export function asTry(): typeof Tag;
            ...
            namespace Task {
                ...
                export const TaskStateId: string;
                export const TaskStateName: string;
                export const Title: string;
                export const UpdatedAt: string;
            }
            namespace TaskState {
                export function asKey(): typeof TaskState;
                export function asTry(): typeof TaskState;
                export const CreatedAt: string;
                export const EntityPlural: string;
                export const EntitySingular: string;
                export const Id: string;
            ...
            namespace TaskTag {
                export function asKey(): typeof TaskTag;
                export function asTry(): typeof TaskTag;
                export const EntityPlural: string;
                export const EntitySingular: string;
                export const Id: string;
                export const TagId: string;
                export const TagName: string;
                export const TaskId: string;
                export const TaskTitle: string;
            }
            namespace Workspace {
                export function asKey(): typeof Workspace;
                export function asTry(): typeof Workspace;
                export const CreatedAt: string;
                export const Description: string;
                export const EntityPlural: string;
                export const EntitySingular: string;
            ...
            namespace WorkspaceMember {
                export function asKey(): typeof WorkspaceMember;
                export function asTry(): typeof WorkspaceMember;
                export const CreatedAt: string;
                export const EntityPlural: string;
                export const EntitySingular: string;
                export const Id: string;
